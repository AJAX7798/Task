...
c=a?this.$G():"AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.be(this.g,{href:a?this.bH():"https://www.anychart.com/?utm_source=trial",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.be(this.b,{alt:a?this.aH():"AnyChart - JavaScript Charts"}),this.I(Uj));this.J(Vj)&&(a=a?this.text():"",$.xe(this.D,a),this.I(Vj));if(this.J(Wj)){if(a=ak(this)?this.XC():Yj()){if(this.P=a,b=Lg($.Af()))$.pd(b,"complete",this.tZ,!1,this),$.pd(b,
...
if(!_.pie){_.pie=1;(function($){var GJ=function(a,b,c,d){if(a>b){var e=a;a=b;b=e}c>d&&(e=c,c=d,d=e);return Math.max(a,c)<=Math.min(b,d)},HJ=function(a,b,c,d,e,f,h,k){return GJ(a,c,e,h)&&GJ(b,d,f,k)&&0>=((c-a)*(f-b)-(d-b)*(e-a))*((c-a)*(k-b)-(d-b)*(h-a))&&0>=((h-e)*(b-f)-(k-f)*(a-e))*((h-e)*(d-f)-(k-f)*(c-e))},IJ=function(a,b,c,d,e){var f=!1,h;if(!e)return!1;var k=0;for(h=e.length;k<h-1;k+=2){var l=k==h-2?0:k+2;var m=k==h-2?1:k+3;f=f||HJ(e[k],e[k+1],e[l],e[m],a,b,c,d)}return f},JJ=function(a,b,c,d){var e=!1,f;if(!d)return!1;var h=
0;for(f=d.length;h<f-1;h+=2)if(!e){e=d[h];var k=d[h+1];e=(a-e)*(a-e)+(b-k)*(b-k)>c*c}return e},sea=function(){return new $.xv},KJ=function(a,b,c){$.Sw.call(this,null,[],[],b,c);this.va=a},MJ=function(a,b,c,d,e,f){$.Xp.call(this,a);this.g=b;this.f=d||null;this.o=e||function(a,b){a.value+=Math.max(0,+b)||0;return a};this.D=f||function(){return{value:0}};this.b=new LJ;this.b.j(0,"groupedPoint",!0);this.b.j(0,"name",c)},LJ=function(){$.Ep.call(this);$.cq(this);this.f=void 0},OJ=function(a,b,c){$.Sw.call(this,
null,[],[],b,c);this.va=a;this.g=NJ(this.va);this.Vx=this.va.i("connectorStroke")},PJ=function(a,b){$.Wx.call(this,a,b)},RJ=function(a,b){$.sv.call(this);this.ib("pieFunnelPyramidBase","pie");this.contextMenu(this.pa.contextMenu);$.V(this);this.ue=this.Km=this.pd=this.Fa=this.Bc=null;this.nb={};this.zi=function(){var a=this.sourceColor,b=this.aquaStyleObj;return{keys:[{offset:0,color:$.rk(a,.5)},{offset:.95,color:$.sk(a,.4)},{offset:1,color:$.sk(a,.4)}],cx:.5,cy:.5,fx:b.fx,fy:b.fy,mode:b.mode}};this.o=
[];this.state=new $.Wu(this);this.data(a||null,b);this.u(4294967295);$.T(this.za,[["overlapMode",4096,1],["radius",4,1],["innerRadius",4,1],["startAngle",4112,1],["sort",16,1,0,function(){QJ(this)}],["insideLabelsOffset",4100,9],["connectorLength",4100,9],["outsideLabelsCriticalAngle",4096,1],["forceHoverLabels",4096,1],["connectorStroke",16,1],["mode3d",4116,1],["sliceDrawer",16,1]]);var c={};$.T(c,[["explode",4116,1],["fill",528,1],["stroke",528,1],["hatchFill",528,1],["labels",0,0],["outline",
0,0]]);this.ia=new $.Iv(this,c,$.Jk,[[1,"fill",function(a){var b=!1;$.z(a[0])&&(a[0]=a[0].toLowerCase(),b="aquastyle"==a[0]);return this.i("mode3d")&&b?this.i("fill"):$.G(a[0])||b?a[0]:$.Kb.apply(null,a)}]]);this.ia.ca.labelsFactoryConstructor=sea;$.Fp(this.ia,"labelsAfterInitCallback",function(a){$.U(a,this.Vd,this);a.lb(this);this.u(4096,1)});$.Fp(this.ia,"outlineAfterInitCallback",function(a){$.U(a,this.ada,this);this.u(16,1)});c={};$.T(c,[["explode",4116,1],["fill",16,1],["stroke",16,1],["hatchFill",
0,0],["labels",0,0],["outline",16,1]]);this.Ca=new $.Iv(this,c,1);this.Ca.ca.labelsFactoryConstructor=$.Lv;c={};$.T(c,[["explode",4116,1],["fill",16,1],["stroke",16,1],["hatchFill",0,0],["labels",0,0],["outline",16,1]]);this.Ga=new $.Iv(this,c,2);this.Ga.ca.labelsFactoryConstructor=$.Lv;this.ba(!1)},QJ=function(a){$.Zc(a.la);delete a.kf;a.la=tea(a,a.Km);$.U(a.la,a.Ke,a);$.M(a,a.la);a.u(13104,17)},tea=function(a,b){if(null!=a.Bc){var c=b;b=new MJ(b,"value",a.bo,a.Bc,void 0,function(){return{value:0}});
$.M(c,b);b.AT=!0}c=a.i("sort");"none"!=c&&null!=c&&(b="asc"==c?b.sort("value",function(a,b){return a-b}):b.sort("value",function(a,b){return b-a}),b.AT=!0);return b},TJ=function(a,b,c){if(!a)return $.zk;var d=b+"|"+a+"|"+c,e=SJ[d];if(!e){switch(b){case 2:e=$.Bk;break;case 3:e=$.Ck;break;default:case 1:e=$.Dk}SJ[d]=e=$.qa(uea,a,e,3==b,c)}return e},uea=function(a,b,c,d,e,f,h,k){if(f!=$.Jk&&d){var l=e.sc(a,f,e.aa(),b,!1,void 0,h);c&&!0===l&&(l=b(e.Bg()));if($.n(l)){if(!$.G(l))return l;if(c)return c=
e.Qh(h),b(l.call(c,c))}}a=e.sc(a,0,e.aa(),b,!1,void 0,h);d=$.n(k)?k:a;k=$.z(a)&&"aquastyle"==a;c&&!0===a&&(a=b(e.Bg()));$.G(a)&&(c=c?e.Qh(h):e.Fe(d,h),a=b(a.call(c,c)));k&&(c=e.aa(),c={aquaStyleObj:e.nb,sourceColor:e.Yb().gc(c.ja())},a=e.zi.call(c));l&&(c=e.Fe(a,h),a=b(l.call(c,c)));return a},UJ=function(a,b,c){c=a.aa().j(c||"hatchSlice");null!=c&&(a=TJ("hatchFill",3,!0)(a,b,!1),c.stroke(null).fill(a))},VJ=function(a){return $.F(a)&&a.hasOwnProperty("mode")&&a.hasOwnProperty("cx")},WJ=function(a){a=
null===a?window.NaN:+a;return!($.B(a)&&!(0,window.isNaN)(a)&&0<a)},NJ=function(a){return"outside"==$.Cj(a.labels().i("position"))},XJ=function(a,b){var c=b.ja();a.Ha&&(a.Ha[c]=null)},vea=function(a){a.Ia=[];var b=a.i("mode3d");a.P?(a.P.clear(),b&&a.Sb.clear()):(a.P=new $.pz(function(){return $.Vi()},function(a){a.clear()}),a.P.parent(a.Va),a.P.zIndex(32),b&&(a.Sb=new $.pz(function(){return $.Vi()},function(a){a.clear()}),a.Sb.parent(a.Va),a.Sb.zIndex(29)));a.D=[];b=a.i("connectorStroke");a.Uc||(a.Uc=
a.Va.path(),a.Uc.stroke(b))},aK=function(a){var b=a.aa(),c=a.i("mode3d"),d="allow-overlap"==a.i("overlapMode");vea(a);var e;if(!d){var f={};var h=e=!1}for(b.reset();b.advance();)if(!WJ(b.get("value"))){var k=b.ja(),l=$.av(a.state,k);var m=b.j("start");var p=b.j("sweep");var q=(m+p/2)*Math.PI/180;p=$.Za($.$a(q));m=90>p||270<p;var r=YJ(a,k);var t=c?.45*a.b:a.b;var u=r[0]+a.b*Math.cos(q);t=r[1]+t*Math.sin(q);c&&(t+=.2*a.b/2);q=m?5:-5;b.j("connector",q);a.Ia[2*k]=u;a.Ia[2*k+1]=t;b.j("anchor",m?"left-center":
"right-center");u=a.Ed(l,!1);XJ(a,u);u.ta=p;l=ZJ(a,l);b.j("explode",l);a.yd&&-1!=(0,$.wa)(a.yd,k)&&u.enabled(!1);if(d)u&&0!=u.enabled()&&(k=u.ja(),XJ(a,u),m=a.Tn(u),p=l?a.Ok:a.ze,a.ra=Math.max(p.left-m.left,m.Wa()-p.Wa(),p.top-m.top,m.Na()-p.Na(),a.ra),a.D[k]||(t=a.Ia[2*k+1]-.2*a.b/2,m=c&&t<a.pc?$.qz(a.Sb):$.qz(a.P),a.D[k]=m,m.stroke(a.i("connectorStroke")),$J(a,u,m)));else{if(k=f[l]){t=k[0];q=k[1];r=k[2];var v=k[3]}else k=[],t=[],q=[],r=[],v=[],k.push(t,q,r,v,l),f[l]=k;270<p&&!e&&(t.length||r&&r.length)&&
(e=!0);90<p&&!h&&(q.length||v&&v.length)&&(h=!0);m=m?e?v:q:h?r:t;m.push(u)}}a.qj=window.NaN;if(!d){var w=[];$.ta($.sc(f),function(a){var b=a[3].concat(a[1]),c=a[2].concat(a[0]);a=a[4];this.Yv(c,!1,w,a);this.Yv(b,!0,w,a);w=w.concat(c,b)},a)}a.$b||(a.$b=[]);a.yd||(a.yd=[]);k=a.qj;-1!=(0,$.wa)(a.$b,k)?$.sa(a.$b)!=k&&(a.yd.push(k),a.$b.length=0):a.$b.push(k);a.ra=Math.round(a.ra)},bK=function(a){a.b=Math.max(a.b-Math.max(a.ra,0),0);var b=a.i("innerRadius");a.G=$.G(b)?b(a.b):$.O(b,a.b);b=a.G/Math.pow(2,
.5)*2;a.W=$.Ql(a.zc-b/2,a.pc-b/2,b,b);a.La=new $.K(a.zc-a.b,a.pc-a.b,2*a.b,2*a.b);b=a.labels();$.V(b);b.zc(a.zc);b.pc(a.pc);b.Rw(a.b);b.De(a.i("startAngle"));b.ej(360);b.ka(a.La);b.ba(!1);a.gb().labels().ka(a.La)},cK=function(a,b){a.da=b;var c=Math.min(a.W.width/a.da.width,a.W.height/a.da.height);(0,window.isFinite)(c)||(c=0);a.f.Ni.oc(c,0,0,c,a.W.left-a.da.left*c+(a.W.width-c*a.da.width)/2,a.W.top-a.da.top*c+(a.W.height-c*a.da.height)/2)},$J=function(a,b,c){var d=a.data().aa(),e=b.ja(),f=a.i("mode3d");
if(d.select(e)){var h=a.Ia[2*e];e=a.Ia[2*e+1];d=d.j("connector");var k=b.rc().value,l=$.n(b.i("offsetY"))?b.i("offsetY"):a.labels().i("offsetY");l||(l=0);l=$.O(l,a.b);(b=$.n(b.i("offsetX"))?b.i("offsetX"):a.labels().i("offsetX"))||(b=0);var m=$.J(k.angle+$.O(b,360)),p=k.radius+l;b=a.zc+p*Math.cos(m)-d;a=a.pc+(f?k.radiusY+l:p)*Math.sin(m);c.clear().moveTo(h,e).lineTo(b,a).lineTo(b+d,a)}},eK=function(a,b,c){var d=a.aa(),e=d.ja(),f=d.j("start"),h=d.j("sweep");if(c){var k=d.j("slice");var l=d.j("sliceOutline");
var m=d.j("hatchSlice");k&&k.clear();m&&m.clear();l&&l.clear()}else a.Ze&&(k=$.qz(a.Ze),d.j("slice",k)),a.Nd&&(l=$.qz(a.Nd),d.j("sliceOutline",l)),a.g&&(m=$.qz(a.g),d.j("hatchSlice",m));if(k){var p=a.sc("outline.offset",b,d,$.wp,!1)||0;c=a.sc("outline.width",b,d,$.wp,!1)||0;p=$.O(p,a.b);c=$.O(c,a.b);var q=ZJ(a,b);d.j("explode",q);var r=f+h/2;d=q*Math.cos($.J(r));q*=Math.sin($.J(r));var t=a.b;r=t+p;p=t+p+c;t={centerX:a.zc,centerY:a.pc,innerRadius:a.G,outerRadius:t,innerOutlineRadius:r,outerOutlineRadius:p,
startAngle:f,sweepAngle:h,explodeX:d,explodeY:q,path:k};l&&(c?$.Nh(l,a.zc+d,a.pc+q,p,r,f,h):l.clear());a.i("sliceDrawer").call(t,t);k.tag={U:a,index:e};if(a.i("mode3d"))for(h=a.o.length,c=a.aa().ja(),f=0;f<h;f++)l=a.o[f],l.index==c&&dK(a,l.type+"Path"+("outerFront"==l.type||"innerBack"==l.type||"outerBack"==l.type||"innerFront"==l.type?l.start:""),b);else if(h=a.aa(),c=h.j("slice"),$.n(c)){d=TJ("fill",1,!0);l=d(a,b,!1,null);VJ(l)&&null===l.mode&&(l.mode=a.La?a.La:null);c.fill(l);d=TJ("stroke",2,!0);
f=d(a,b,!1,null);VJ(f)&&null===f.mode&&(f.mode=a.La?a.La:null);c.stroke(f);if(c=a.aa().j("sliceOutline"))d=a.sc("outline.enabled",b,h,$.sp,!1),null===d&&(d=a.sc("outline.enabled",0,h,$.sp,!1)),d?(d=TJ("outline.fill",1,!0),h=d(a,0,!1,l),l=d(a,b,!1,h),VJ(l)&&null===l.mode&&(l.mode=a.La?a.La:null),d=TJ("outline.stroke",2,!0),f=d(a,b,!1,f),VJ(f)&&null===f.mode&&(f.mode=a.La?a.La:null)):l=f="none",c.fill(l).stroke(f);UJ(a,b)}m&&(m.Ld(k.F()),m.tag={U:a,index:e},UJ(a,b))}},fK=function(a,b,c,d,e,f,h,k,l,
m){l+=String(e);if(m=a.Yx(l,m)){var p=.45*d,q=.2*a.b;f<e&&(f+=360);360==Math.abs(h)&&(e=0,f=180);h=$.J(e);e=$.J(f);f=b+d*+Math.cos(h).toFixed(5);h=c+p*+Math.sin(h).toFixed(5);b+=d*+Math.cos(e).toFixed(5);c+=p*+Math.sin(e).toFixed(5);m.moveTo(f,h);m.Xe(b,c,d,p,!1,!0);m.lineTo(b,c+q);m.Xe(f,h+q,d,p,!1,!1);m.lineTo(f,h);m.close();dK(a,l,k)}},gK=function(a,b,c,d,e,f,h,k,l,m){l+=String(e);if(m=a.Yx(l,m)){var p=.45*d,q=.2*a.b;f<e&&(f+=360);360==Math.abs(h)&&(e=180,f=0);h=$.J(e);e=$.J(f);f=b+d*Math.cos(h);
h=c+p*Math.sin(h);b+=d*Math.cos(e);c+=p*Math.sin(e);m.moveTo(f,h);m.Xe(b,c,d,p,!1,!0);m.lineTo(b,c+q);m.Xe(f,h+q,d,p,!1,!1);m.lineTo(f,h);m.close();dK(a,l,k)}},hK=function(a,b,c,d,e,f,h,k,l){var m=$.J(h);h=.2*a.b;var p=c+f*Math.cos(m);c+=e*Math.cos(m);f=d+.45*f*Math.sin(m);d+=.45*e*Math.sin(m);if(l=a.Yx(b,l))l.moveTo(p,f),l.lineTo(c,d),l.lineTo(c,d+h),l.lineTo(p,f+h),l.lineTo(p,f),l.close(),dK(a,b,k)},iK=function(a,b,c,d){var e=a.labels();$.V(e);e.fontOpacity(b);e.X();e.ba(!1);if(d&&a.D)for(b=0;b<
a.D.length;b++)if(d=a.D[b])e=a.i("connectorStroke"),e=$.wk(e,c),d.stroke(e)},mK=function(a){var b=a.aa(),c=b.ja(),d=$.av(a.state,c),e=ZJ(a,d);d=b.j("start");b=b.j("sweep");var f=d+b;if($.n(d)&&$.n(b)&&b){var h=d+b/2,k=e*Math.cos($.J(h));e=.45*e*Math.sin($.J(h));a.o.push({index:c,type:"top",start:d,Kr:b,jw:k,lw:e});a.o.push({index:c,type:"bottom",start:d,Kr:b,jw:k,lw:e});360!=Math.abs(b)&&(a.o.push({index:c,type:"start",angle:d,jw:k,lw:e}),a.o.push({index:c,type:"end",angle:f,jw:k,lw:e}));var l=d;
var m=f;if(l==m)h=!1;else{l=$.J(l);m=$.J(m);h=$.Bl(Math.cos(l),7);var p=$.Bl(Math.cos(m),7);l=jK(h,Math.sin(l));m=jK(p,Math.sin(m));h=1==l||2==l?!0:3==l?1==m||2==m?!0:3==m?h>=p:!1:4==l?4==m?h>=p:!0:!1}if(h)for(l=kK(d,f),h=a.o.length,p=l.length,a.o.length=h+p,m=0;m<p;m++)l[m].index=c,l[m].type="outerFront",l[m].Kr=b,l[m].jw=k,l[m].lw=e,a.o[h+m]=l[m];l=d;m=f;l!=m&&a.G?(l=$.J(l),m=$.J(m),h=$.Bl(Math.cos(l),7),p=$.Bl(Math.cos(m),7),l=jK(h,Math.sin(l)),m=jK(p,Math.sin(m)),h=3==l||4==l?!0:1==l?3==m||4==
m?!0:1==m?h<=p:!1:2==l?2==m?h<=p:!0:!1):h=!1;if(h)for(l=lK(d,f),h=a.o.length,p=l.length,a.o.length=h+p,m=0;m<p;m++)l[m].index=c,l[m].type="innerBack",l[m].Kr=b,l[m].jw=k,l[m].lw=e,a.o[h+m]=l[m];l=lK(d,f);h=a.o.length;p=l.length;a.o.length=h+p;for(m=0;m<p;m++)l[m].index=c,l[m].type="outerBack",l[m].Kr=b,l[m].jw=k,l[m].lw=e,a.o[h+m]=l[m];l=kK(d,f);h=a.o.length;p=l.length;a.o.length=h+p;for(m=0;m<p;m++)l[m].index=c,l[m].type="innerFront",l[m].Kr=b,l[m].jw=k,l[m].lw=e,a.o[h+m]=l[m]}},pK=function(a,b,
c){var d=0,e=a.o.length;if($.n(b))for(d=0;d<e;d++){var f=a.o[d];f.index==b&&nK(a,f,c)}else{for(d=0;d<e;d++)switch(f=a.o[d],f.type){case "top":f.gx=1;break;case "outerFront":f.gx=f.Em?1:$.Bl(Math.sin($.J(oK(f.start,f.end))),7);break;case "innerBack":f.gx=f.Em?-1:$.Bl(Math.sin($.J(oK(f.start,f.end))),7);break;case "bottom":f.gx=-3;break;case "innerFront":f.gx=0;break;case "outerBack":f.gx=-2;break;default:f.gx=$.Bl(Math.sin($.J(f.angle)),7)}a.o.sort(function(a,b){return a.gx-b.gx});for(d=0;d<e;d++)nK(a,
a.o[d])}a.o.length=0},nK=function(a,b,c){var d=a.aa();d.select(b.index);var e=$.av(a.state,b.index),f=ZJ(a,e);d.j("explode",f);d=a.zc;var h=a.pc;f&&(d+=b.jw,h+=b.lw);f=a.b;var k=a.G;switch(b.type){case "top":qK(a,d,h,f,k,b.start,b.Kr,e,!0,c);break;case "bottom":qK(a,d,h,f,k,b.start,b.Kr,e,!1,c);break;case "outerFront":fK(a,d,h,f,b.start,b.end,b.Kr,e,"outerFront",c);break;case "innerBack":gK(a,d,h,k,b.start,b.end,b.Kr,e,"innerBack",c);break;case "outerBack":fK(a,d,h,f,b.start,b.end,b.Kr,e,"outerBack",
c);break;case "innerFront":gK(a,d,h,k,b.start,b.end,b.Kr,e,"innerFront",c);break;case "start":hK(a,"startPath",d,h,f,k,b.angle,e,c);break;case "end":hK(a,"endPath",d,h,f,k,b.angle,e,c)}},qK=function(a,b,c,d,e,f,h,k,l,m){0>d&&(d=0);0>e&&(e=0);if(d<e){var p=d;d=e;e=p}p=(l?"top":"bottom")+"Path";c+=l?0:.2*a.b;h=$.Xa(h,-360,360);if(l=a.Yx(p,m))0>=e?360==Math.abs(h)?l.Xd(b,c,d,.45*d,f,h,!1):l.moveTo(b,c).Xd(b,c,d,.45*d,f,h,!0).close():(m=360>Math.abs(h),l.Xd(b,c,d,.45*d,f,h).Xd(b,c,e,.45*e,f+h,-h,m),m&&
l.close()),dK(a,p,k)},rK=function(a,b){var c=a.aa(),d=c.ja(),e=c.get("normal"),f=$.zn($.n(e)?e.fill:void 0,c.get("fill"),a.fill());b=$.Hk(b);2==b?(e=c.get("selected"),c=$.zn($.n(e)?e.fill:void 0,c.get("selectFill"),a.selected().fill(),f),f=a.Al(c,f)):1==b?(e=c.get("hovered"),c=$.zn($.n(e)?e.fill:void 0,c.get("hoverFill"),a.gb().fill(),f),f=a.Al(c,f)):f=a.Al(f);f=$.z(f)?$.nk(f):$.nk(f.color);d=a.Yb().gc(d);var h;$.F(d)&&(d.color?h=$.nk(d.color):d.keys&&d.keys.length&&(h=$.nk(d.keys[0].color)));h=h?
h.mj:d;return f?f.mj:h},dK=function(a,b,c){var d=a.aa(),e=d.ja(),f=rK(a,c),h=$.gk(f),k=d.j(b);k.tag={U:a,index:e};var l,m=$.kk(h,.3),p=$.jk([255,255,255],h,.1),q=$.Jb($.jk(h,m,.7));p=$.Jb($.jk(m,p,.1));var r=$.Jb($.jk(h,m,.8)),t=$.Jb($.jk(h,m,.2));h=$.Jb($.jk(h,m,.1));var u=$.Hk(c);m=1==u;u=2==u;var v=$.xk(m?a.gb().fill():u?a.selected().fill():a.fill());t={color:m||u?$.rk(t,.2):t,opacity:v};p={angle:45,keys:[{position:0,opacity:v,color:m||u?$.rk(f,.2):$.rk(f,.1)},{position:.19,opacity:v,color:m||
u?$.rk(p,.2):p},{position:1,opacity:v,color:m||u?$.rk(r,.2):r}]};q=f={angle:-50,keys:[{position:0,opacity:v,color:m||u?$.rk(f,.3):f},{position:1,opacity:v,color:m||u?$.rk(q,.2):q}]};"topPath"==b?l=f:"bottomPath"==b?l=q:$.Vb(b,"outer")?l=p:$.Vb(b,"inner")?l=t:l={color:m||u?$.rk(h,.2):h,opacity:v};var w;u&&$.Gk(a.selected().stroke())?w=a.selected().stroke():$.Gk(a.stroke())?w=a.stroke():w=l;k.fill(l);k.stroke(w);b="hatch"+String(b.charAt(0)).toUpperCase()+b.substr(1);if(d=d.j(b))d.Ld(k.F()),d.tag={U:a,
index:e},UJ(a,c,b)},jK=function(a,b){return 0<=a&&0<=b?1:0>=a&&0<=b?2:0>=a&&0>b?3:4},kK=function(a,b){var c=$.Bl(Math.cos($.J(a)),7),d=$.Bl(Math.cos($.J(b)),7),e=jK(c,Math.sin($.J(a))),f=jK(d,Math.sin($.J(b))),h=[];if(1==e)switch(f){case 1:c>=d?h.push({start:a,end:b}):(h.push({start:a,end:180,Em:!0}),h.push({start:360,end:b}));break;case 2:h.push({start:a,end:b,Em:!0});break;case 3:case 4:h.push({start:a,end:180,Em:!0})}else if(2==e)switch(f){case 1:h.push({start:a,end:180});h.push({start:360,end:b});
break;case 2:c>=d?h.push({start:a,end:b}):(h.push({start:a,end:180}),h.push({start:360,end:b,Em:!0}));break;case 3:case 4:h.push({start:a,end:180})}else if(3==e)switch(f){case 1:h.push({start:360,end:b});break;case 2:h.push({start:360,end:b,Em:!0});break;case 3:c>=d&&h.push({start:0,end:180,Em:!0})}else if(4==e)switch(f){case 1:h.push({start:360,end:b});break;case 2:h.push({start:360,end:b,Em:!0});break;case 3:h.push({start:360,end:180,Em:!0});break;case 4:c>=d&&h.push({start:0,end:180,Em:!0})}return h},
lK=function(a,b){var c=$.Bl(Math.cos($.J(a)),7),d=$.Bl(Math.cos($.J(b)),7),e=jK(c,Math.sin($.J(a))),f=jK(d,Math.sin($.J(b))),h=[];if(1==e)switch(f){case 1:c<=d&&h.push({start:180,end:360});break;case 3:h.push({start:180,end:b});break;case 4:h.push({start:180,end:b,Em:!0})}else if(2==e)switch(f){case 1:h.push({start:180,end:360,Em:!0});break;case 2:c<=d&&h.push({start:180,end:360,Em:!0});break;case 3:h.push({start:180,end:b});break;case 4:h.push({start:180,end:b,Em:!0})}else if(3==e)switch(f){case 1:case 2:h.push({start:a,
end:360,Em:!0});break;case 3:c>=d?(h.push({start:a,end:360}),h.push({start:180,end:b})):h.push({start:a,end:b});break;case 4:h.push({start:a,end:b,Em:!0})}else if(4==e)switch(f){case 1:case 2:h.push({start:a,end:360});break;case 3:h.push({start:a,end:360});h.push({start:180,end:b});break;case 4:c>=d?(h.push({start:a,end:360}),h.push({start:180,end:b})):h.push({start:a,end:b})}return h},YJ=function(a,b){var c=a.aa();c.select(b);var d=a.zc,e=a.pc,f=$.av(a.state,b);if(f=ZJ(a,f)){var h=a.i("mode3d"),
k=c.j("start");c=c.j("sweep");c=(k+c/2)*Math.PI/180;h=(h?.45*f:f)*Math.sin(c);d+=f*Math.cos(c);e+=h}return[d,e]},oK=function(a,b){b<a&&(b+=360);return(a+b)/2},ZJ=function(a,b,c){b=b||0;var d=a.aa();1==d.Ob()?a=0:(c=a.sc("explode",b,d,$.wp,!1,void 0,c),a=$.n(c)?$.O(c,a.Qf):0);return a},sK=function(a){var b=a.Ya();a.dc($.bj()||$.aj()?"touchstart":"mousemove",a.uN);b.kd()},tK=function(a,b,c,d){this.G=d;this.g=c;this.xf=b;this.labels=[];this.y=this.height=0;this.b=[];this.f=a;this.gF=!1;this.gk=null},
uK=function(a,b){b&&(a.labels.push(b),a.Yv())},vK=function(a,b){var c=$.Rl(a.eb());return!$.Kl(c,$.Rl(b))},wea=function(a){for(var b=0,c=a.labels.length;b<c;b++){var d=a.labels[b],e=a.b[3*b],f=a.b[3*b+1],h=a.b[3*b+2],k=d.rc().value;k.angle=e;k.radius=f;k.radiusY=h;XJ(a.xf,d)}},wK=function(a,b){var c=new RJ(a,b);c.sf();return c},xK=function(a,b){var c=new RJ(a,b);c.ib("pie3d");c.sf();return c};$.I(KJ,$.Sw);$.g=KJ.prototype;
$.g.update=function(){this.b.length=this.f.length=0;for(var a=this.va.Bf();a.advance();)if(!a.j("missing")){var b=a.j("start"),c=a.j("sweep"),d=this.va.b,e=this.va.JX();this.b.push(this.va.wi(),0,0,0);this.f.push(b,c,d,e)}};$.g.fv=function(){iK(this.va,1E-5,1E-5,NJ(this.va))};
$.g.bm=function(){for(var a=this.va.Bf(),b=0;a.advance();)if(!a.j("missing")){a.j("start",this.coords[b++]);a.j("sweep",this.coords[b++]);a.j("radius",this.coords[b++]);a.j("innerRadius",this.coords[b++]);var c=this.va,d=a,e=d.j("slice");e.clear();var f=d.j("start"),h=d.j("sweep"),k=d.j("radius"),l=d.j("innerRadius"),m=$.av(c.state,d.ja());if(m=ZJ(c,m)){var p=f+h/2;e=$.Nh(e,c.zc+m*Math.cos($.J(p)),c.pc+m*Math.sin($.J(p)),k,l,f,h)}else e=$.Nh(e,c.zc,c.pc,k,l,f,h);if(f=d.j("hatchSlice"))c.aa().select(d.ja()),
f.clear(),f.Ld(e.F()),c=TJ("hatchFill",3,!0)(c,$.av(c.state,d.ja()),!1,null),f.stroke(null).fill(c)}};$.g.al=function(){this.bm()};$.g.R=function(){KJ.B.R.call(this);this.va=null};$.I(MJ,$.Xp);$.g=MJ.prototype;$.g.sD=function(){var a=[],b=this.Cd.aa(),c=void 0,d=void 0;if(this.f)for(;b.advance();){var e=b.get(this.g),f=b.get("name");$.n(f)||(f="Point "+b.ja());this.f(e)?a.push(b.ja()):c?(c.push(e),d.push(f)):(c=[e],d=[f])}else for(e=0,b=b.Ob();e<b;e++)a.push(e);c?(this.b.Df(0,(0,$.bg)(c,this.o,this.D())),this.b.j(0,"names",d),this.b.j(0,"values",c)):(this.b.Df(0,c),this.b.j(0,"names",[]),this.b.j(0,"values",[]));return a};
$.g.Ob=function(){$.Yp(this);return(this.pn?this.pn.length:this.Cd.Ob())+this.b.Ob()};$.g.Uk=function(a){$.Yp(this);var b=this.Cd.Ob();return a<b?this.Cd.Uk(a):this.b.Uk(a-b)};$.g.As=function(){return $.Ea(this.Cd.As(),this.b)};$.g.Df=function(a,b){$.Yp(this);var c=this.pn?this.pn.length:this.Cd.Ob();if(a<c)return $.Xp.prototype.Df.apply(this,arguments);a-=c;return this.b.Df.apply(this.b,arguments)};
$.g.DK=function(a,b,c){var d=this.pn?this.pn.length:this.Cd.Ob();if(a>d)throw Error("Index can not be masked by this View");return a>=d?(a-=d,2<arguments.length?(this.b.j.apply(this.b,arguments),this):this.b.j.apply(this.b,arguments)):$.Xp.prototype.DK.apply(this,arguments)};$.I(LJ,$.dq);LJ.prototype.Df=function(a,b){if(!a){var c=this.f;1<arguments.length&&(this.f=b);return c}};LJ.prototype.j=function(a,b,c){if(!a)return $.Xp.prototype.j.apply(this,arguments)};
LJ.prototype.Ob=function(){return $.n(this.f)?1:0};var yK=LJ.prototype;yK.row=yK.Df;yK.getRowsCount=yK.Ob;$.I(OJ,$.Sw);OJ.prototype.update=function(){this.b.length=this.f.length=0;this.b.push(1E-5,1E-5);this.f.push(1,this.Vx.opacity||1)};OJ.prototype.bm=function(){iK(this.va,this.coords[0],this.coords[1],this.g)};OJ.prototype.al=function(){this.bm()};OJ.prototype.R=function(){OJ.B.R.call(this);this.Vx=this.va=null;delete this.g};$.I(PJ,$.Wx);PJ.prototype.wi=function(){return this.va.data().j(this.index,"start")};PJ.prototype.f=function(){var a=this.va.data(),b=a.j(this.index,"start");a=a.j(this.index,"sweep");return b+a};PJ.prototype.b=function(a){$.Rj(405,null,["exploded()","selected()"],!0);return this.selected(a)};var zK=PJ.prototype;zK.getStartAngle=zK.wi;zK.getEndAngle=zK.f;zK.hovered=zK.gb;zK.selected=zK.selected;zK.exploded=zK.b;$.I(RJ,$.sv);$.ap(RJ,["fill","stroke","hatchFill","outline"],"normal");$.ap(RJ,["explode"],"selected");RJ.prototype.ua=$.sv.prototype.ua|16;RJ.prototype.oa=$.sv.prototype.oa|28688;
var AK=function(){var a={};$.No(a,[[0,"overlapMode",$.Aj],[0,"radius",function(a){return $.an(a,"100%")}],[0,"innerRadius",function(a){return $.G(a)?a:$.an(a)}],[0,"startAngle",function(a){return $.Za($.R(a)||0)}],[0,"sort",$.sj],[2,"",function(a){return $.an(a,"30%")},"outsideLabelsSpace"],[0,"insideLabelsOffset",$.an],[0,"connectorLength",function(a){return $.an(a,"20%")}],[0,"outsideLabelsCriticalAngle",function(a){return $.Za($.O(a))}],[0,"forceHoverLabels",$.Wo],[1,"connectorStroke",$.ip],[0,
"mode3d",$.Xo],[0,"sliceDrawer",$.Bp]]);return a}();$.$o(RJ,AK);$.g=RJ.prototype;$.g.Qa=function(){return this.i("mode3d")?"pie-3d":"pie"};$.g.dg=function(){return!0};$.g.pj=function(){return!1};$.g.Wh=function(){return!0};$.g.Se=function(){return[this]};
$.g.data=function(a,b){if($.n(a)){if(a){var c=a.title||a.caption;c&&this.title(c);a.rows&&(a=a.rows)}if(this.Hg!==a){this.Hg=a;if(this.Km!=a||null===a){$.Zc(this.ue);if($.L(a,$.Xp)){var d=a;this.ue=null}else $.L(a,$.gq)?d=(this.ue=a).te():d=(this.ue=new $.gq($.D(a)||$.z(a)?a:null,b)).te(),$.M(this,this.ue);this.Km=d.Kl()}QJ(this)}return this}return this.la};$.g.Ke=function(a){$.W(a,16)&&this.u(13104,17)};$.g.aa=function(){return this.kf||(this.kf=this.la.aa())};$.g.tc=function(){return this.kf=this.la.aa()};
$.g.Bf=function(){return this.la.aa()};$.g.group=function(a,b){return $.n(a)?($.G(a)&&a!=this.Bc?(this.Bc=a,this.bo=b||"Grouped point",QJ(this)):$.Bn(a)&&(this.Bc=null,QJ(this)),this):this.Bc};$.g.Yb=function(a){if($.L(a,$.br))return this.Tc($.br,a),this;if($.L(a,$.Zq))return this.Tc($.Zq,a),this;$.F(a)&&"range"==a.type?this.Tc($.br):($.F(a)||null==this.Fa)&&this.Tc($.Zq);return $.n(a)?(this.Fa.N(a),this):this.Fa};
$.g.Tc=function(a,b){if($.L(this.Fa,a))b&&this.Fa.N(b);else{var c=!!this.Fa;$.Zc(this.Fa);this.Fa=new a;$.Qp(this,"palette",this.Fa);this.Fa.Br();b&&this.Fa.N(b);$.U(this.Fa,this.If,this);$.M(this,this.Fa);c&&this.u(528,1)}};$.g.Sd=function(a){this.pd||(this.pd=new $.$q,$.U(this.pd,this.If,this),$.M(this,this.pd));return $.n(a)?(this.pd.N(a),this):this.pd};$.g.If=function(a){$.W(a,2)&&this.u(528,1)};var SJ={};$.g=RJ.prototype;
$.g.sc=function(a,b,c,d,e,f,h){var k=!!(b&1),l=!!(b&2);f=l?this.Ga:k?this.Ca:this.ia;e=a.split(".");f=(0,$.bg)(e,function(a,b){return a[b]()},f);h?a=f:(h=c.get(l?"selected":k?"hovered":"normal"),h=$.n(h)?(0,$.bg)(e,function(a,b){return a?a[b]:a},h):void 0,a=$.zn(h,c.get($.Kk(b,a)),f));$.n(a)&&(a=d(a));return a};$.g.Bg=function(){return $.Pb(this.Sd().gc(this.aa().ja())||"none")};$.g.Qh=function(){var a=this.aa();return{index:a.ja(),sourceHatchFill:this.Bg(),iterator:a}};
$.g.Fe=function(a,b){var c=this.aa(),d;b||(d=c.get("fill"));return{index:c.ja(),sourceColor:$.Kb(a||d||this.Yb().gc(c.ja())||"blue"),iterator:c,series:this,chart:this}};$.g.Al=function(a,b){var c=this.aa().ja();if($.z(a)&&"aquastyle"==a)c={aquaStyleObj:this.nb,sourceColor:this.Yb().gc(c)},c=this.zi.call(c);else if($.G(a)){var d=1<arguments.length?this.Al.apply(this,$.Ha(arguments,1)):this.Yb().gc(c);c={index:c,sourceColor:d,iterator:this.aa()};c=a.call(c)}else c=a;return c};$.g.uk=function(){return!this.aa().Ob()};
$.g.Dx=function(a){this.f||(this.f=new $.oz(this),$.U(this.f,this.lda,this),$.Qp(this,"center",this.f));return $.n(a)?(this.f.N(a),this):this.f};$.g.lda=function(a){var b=0,c=0;$.W(a,1)&&(b|=16,c|=1);$.W(a,8)&&(b|=16388,c|=1);this.u(b,c)};$.g.labels=function(a){return $.n(a)?(this.ia.labels(a),this):this.ia.labels()};$.g.Tn=function(a){this.Ha||(this.Ha=[]);var b=a.ja();this.Ha[b]||(this.Ha[b]=$.Sl(this.labels().vk(a)));return this.Ha[b]};
$.g.Vd=function(a){var b=0,c=0;$.W(a,1)&&(b|=4096,c|=1);$.W(a,8)&&(b|=4100,c|=9);this.u(b,c)};$.g.ada=function(){this.u(20,1)};
$.g.Fc=function(a){var b=this.aa();if(!this.Id||a)this.Id=new $.tu;this.Id.lg(b).oi([this.vd(b.ja()),this]);a={x:{value:b.get("x"),type:"string"},value:{value:b.get("value"),type:"number"},name:{value:b.get("name"),type:"string"},index:{value:b.ja(),type:"number"},chart:{value:this,type:""}};b.j("groupedPoint")&&(a.name={value:b.j("name"),type:"string"},a.groupedPoint={value:!0,type:"string"},a.names={value:b.j("names"),type:""},a.values={value:b.j("values"),type:""});return $.et(this.Id,a)};
$.g.Oi=function(){var a=NJ(this),b=this.aa(),c=b.j("start"),d=b.j("sweep"),e=1==b.Ob()||360==d;b=$.av(this.state,b.ja());b=ZJ(this,b);c+=d/2;var f=this.i("mode3d");d=this.i("insideLabelsOffset");if(f){if(a)e=this.b+this.K,d=.45*this.b+this.K,b&&(e+=b,d+=.45*b);else{var h=this.b;a=.45*this.b;var k=this.G;f=.45*this.G;e&&!k?d=e=0:(e=$.O(d,k+h),d=$.$m(d)?$.O(d,f+a):.45*$.O(d,f+a),b&&(e+=b,d+=.45*b))}return{value:{angle:c,radius:e,radiusY:d}}}return{value:{angle:c,radius:a?this.b+this.K+b:$.O(d,e&&!this.G?
0:this.b-this.G)+this.G+b,outerRadius:this.b,innerRadius:this.G}}};
$.g.Yv=function(a,b,c,d){var e,f,h,k,l,m,p=null,q=this.aa(),r=[],t=b?$.ta:$.le;t(a,function(a){a&&0!=a.enabled()&&(q.select(a.ja()),a.vf(this.Fc()),A=this.Tn(a),!p||vK(p,A)?(p&&r.push(p),p=new tK(b,this,r,d||0),p.$z(a)):p.$z(a))},this);p&&r.push(p);a=0;for(e=r.length;a<e;a++)(p=r[a])&&p.Qn&&(f||(f=[]),f=$.Ea(f,p.Qn));p=null;f&&($.Oa(f,function(a,b){return a.ja()>b.ja()?1:a.ja()<b.ja()?-1:0}),t(f,function(a){if(a){q.select(a.ja());a.vf(this.Fc());A=this.Tn(a);h=!0;k=0;for(l=r.length;k<l;k++)h=h&&vK(r[k],
A);if(h){p||(p=new tK(b,this,[],d||0));uK(p,a);m=p.eb();h=!0;for(k=0;k<l;k++)h=h&&vK(r[k],m);p.gF||!h?(p.labels.pop().enabled(!1),p.Yv(),r.push(p),p=null):a.enabled(!0)}else p&&(r.push(p),p=null)}},this),p&&r.push(p));var u,v,w=this.i("mode3d"),x=this.i("connectorStroke");a=0;for(e=r.length;a<e;a++)if(p=r[a]){wea(p);var y=0;for(u=p.labels.length;y<u;y++)if((f=p.labels[y])&&0!=f.enabled()){XJ(this,f);t=f.ja();q.select(t);var A=this.Tn(f);if(c){var E=this.Ia[2*t],C=this.Ia[2*t+1],N=q.j("connector"),
P=f.rc().value,Q=P.angle;Q=$.J(Q);P=P.radius;var S=this.zc+P*Math.cos(Q)-N,oa=this.pc+P*Math.sin(Q);var xa=0;for(v=c.length;xa<v;xa++){Q=c[xa];XJ(this,Q);var La=this.Tn(Q),sb=Q.ja(),bc=YJ(this,sb),cb=bc[0],cc=bc[1],Eb=q.j("start"),Ac=q.j("sweep");bc=this.Ia[2*sb];sb=this.Ia[2*sb+1];N=q.j("connector");P=Q.rc().value;Q=P.angle;Q=$.J(Q);P=P.radius;N=this.zc+P*Math.cos(Q)-N;P=this.pc+P*Math.sin(Q);Q=$.J(Eb);var uf=cb+this.G*Math.cos(Q),Qb=cc+this.G*Math.sin(Q),Ld=cb+this.b*Math.cos(Q),Nb=cc+this.b*Math.sin(Q);
Q=$.J(Eb+Ac);Eb=cb+this.G*Math.cos(Q);Ac=cc+this.G*Math.sin(Q);cb+=this.b*Math.cos(Q);cc+=this.b*Math.sin(Q);Q=$.Rl(A);if($.Kl(Q,$.Rl(La))||IJ(uf,Qb,Ld,Nb,Q)||IJ(Eb,Ac,cb,cc,Q)||IJ(bc,sb,N,P,Q)||HJ(E,C,S,oa,uf,Qb,Ld,Nb)||HJ(E,C,S,oa,Eb,Ac,cb,cc)||HJ(bc,sb,N,P,E,C,S,oa)||$.Kl(Q,[Ld,Nb,uf,Qb])||$.Kl(Q,[cb,cc,Eb,Ac])){f.enabled(!1);break}}}0!=f.enabled()&&(this.ng&&(xa=d?this.Ok:this.ze,xa=Math.max(xa.left-A.left,A.Wa()-xa.Wa(),xa.top-A.top,A.Na()-xa.Na()),xa>this.ra&&(this.qj=t),this.ra=Math.max(this.ra,
xa)),this.D[t]||(xa=this.Ia[2*t+1]-.2*this.b/2,xa=w&&xa<this.pc?$.qz(this.Sb):$.qz(this.P),this.D[t]=xa,xa.stroke(x),$J(this,f,xa)))}}};
$.g.Ym=function(a){this.Qf=Math.min(a.width,a.height);var b=ZJ(this,$.Jk,!0),c=ZJ(this,1,!0),d=ZJ(this,2,!0),e=Math.max(b,c||0,d||0),f=this.aa();for(f.reset();f.advance();)b=ZJ(this,$.Jk),c=ZJ(this,1),d=ZJ(this,2),e=Math.max(b,c||0,d||0,e);b=this.ia.labels().enabled()||this.Ca.labels().enabled()||this.Ga.labels().enabled();e=NJ(this)&&b?e:0;this.ze=$.Ql(a.left+e,a.top+e,a.width-2*e,a.height-2*e);b=this.Qf-2*e;c=Math.max($.O(this.i("radius"),b),0);this.i("mode3d")?this.b=Math.min(Math.min(c,(a.width-
2*e)/2),(a.height-2*e)/1.3):this.b=Math.min(b/2,c);this.K=$.O(this.i("connectorLength"),this.b);this.Xl=this.b;this.ra=0;this.zc=this.ze.left+this.ze.width/2;this.pc=this.ze.top+this.ze.height/2;b=$.J(-145);c=Math.min(a.width,a.height)/2;e=.5*c*Math.cos(b)/a.width+.5;b=.5*c*Math.sin(b)/a.height+.5;0>a.width&&(a.width=0);0>a.height&&(a.height=0);this.nb.fx=!(0,window.isNaN)(e)&&(0,window.isFinite)(e)?e:0;this.nb.fy=!(0,window.isNaN)(b)&&(0,window.isFinite)(b)?b:0;this.nb.mode=a;bK(this)};
$.g.kb=function(){if(this.J(8192)){this.gG();for(var a=this.data().aa(),b,c=0,d=Number.MAX_VALUE,e=-Number.MAX_VALUE,f=0;a.advance();)b=a.get("value"),WJ(b)?c++:(b=+b,d=Math.min(b,d),e=Math.max(b,e),f+=b);a=a.Ob()-c;var h;a?h=f/a:d=e=f=h=void 0;this.ya("count",a);this.ya("min",d);this.ya("max",e);this.ya("sum",f);this.ya("average",h);this.I(8192)}};$.g.Lt=function(){this.Fa&&$.L(this.Fa,$.br)&&$.cr(this.Fa,this.aa().Ob())};$.g.SG=function(){var a=this.f.sh.eb();$.jb(a,this.da)||cK(this,a)};
$.g.HH=function(){this.u(4,1)};
$.g.Lj=function(a){this.kb();$.Qs(this.labels());var b=this.aa();b.Ob();var c=this.i("mode3d"),d=this.Dx();this.J(16384)&&(d&&d.Ni&&(this.f.yD(),this.f.Ni.parent(this.Va),this.f.Ni.zIndex(25),this.f.Ni&&($.L(this.f.sh,$.tf)?this.f.Ni.Da().qa("renderfinish",this.SG,!1,this):$.L(this.f.sh,$.X)&&this.f.Ni.qa("chartdraw",this.HH,!1,this))),this.I(16384));this.J(4)&&(this.Ym(a),this.u(4112));if(this.J(16)){this.ng=!0;var e=this.wi();var f=0;for(b.reset();b.advance();)if(f=b.get("value"),WJ(f))b.j("missing",
!0);else{f=+f;f=f/this.Tf("sum")*360;var h=b.get("state");h="selected"==h?2:"hovered"==h?1:"normal"==h?$.Jk:window.NaN;(0,window.isNaN)(h)||this.state.Kg(h,b.ja());b.j("start",e).j("sweep",f).j("explode",ZJ(this,h));e+=f}}if(this.J(4096)){this.labels().O()||this.labels().O(this.Va);this.labels().clear();this.$b&&(this.$b.length=0);this.yd&&(this.yd.length=0);this.P&&(this.P.clear(),c&&this.Sb.clear());if(this.labels().enabled()){var k=NJ(this)?"outsideLabels":"insideLabels";e=$.Pp(this,k,!0,function(){var a=
new $.Ep;$.M(this,a);$.Qp(this,k,a);return a}).pa;this.labels().op(e.autoColor);this.labels().disablePointerEvents(e.disablePointerEvents);if(NJ(this)){if(this.ng&&(this.b=this.Xl,this.ra=Number.NEGATIVE_INFINITY),aK(this),this.ng){for(e=5;this.ra&&(0,window.isFinite)(this.ra)&&e&&10<Math.abs(this.ra);)bK(this),this.ra=Number.NEGATIVE_INFINITY,this.labels().clear(),this.P&&(this.P.clear(),c&&this.Sb.clear()),aK(this),e--;this.u(4)}}else for(b.reset();b.advance();)WJ(b.get("value"))||(e=$.av(this.state,
b.ja()),this.Ed(e,!!(e&1)))}this.labels().X();this.labels().Le().clip(a);this.u(16);this.I(4096)}if(this.J(16)){a=this.ia.Ur().i("offset")||this.ia.Ur().i("width")||this.Ca.Ur().i("offset")||this.Ca.Ur().i("width")||this.Ga.Ur().i("offset")||this.Ga.Ur().i("width");this.Nd?this.Nd.clear():a&&(this.Nd=new $.pz(function(){return $.Vi()},function(a){a.clear()}),this.Nd.zIndex(30),this.Nd.parent(this.Va));this.Ze?this.Ze.clear():(this.Ze=new $.pz(function(){return $.Vi()},function(a){a.clear()}),this.Ze.zIndex(30),
this.Ze.parent(this.Va));this.g?this.g.clear():(this.g=new $.pz(function(){return $.Vi()},function(a){a.clear()}),this.g.parent(this.Va),this.g.zIndex(31).gd(!0));c&&(this.o.length=0);for(b.reset();b.advance();)WJ(b.get("value"))||(e=$.av(this.state,b.ja()),c?mK(this):eK(this,e));c&&pK(this);b=this.i("connectorStroke");if(this.D)for(c=0;c<this.D.length;c++)(a=this.D[c])&&a.stroke(b);this.G?(c=this.f.i("fill"),a=this.f.i("stroke"),this.ta||(this.ta=$.Si()),e=this.G-$.Rb(a)/2,this.ta.parent(this.Va).zIndex(20).stroke(a).fill(c).rb(e)):
this.ta&&this.ta.parent(null);this.Uc&&this.Uc.stroke(b);this.I(16)}this.J(4)&&d&&(b=d.sh,d=d.Ni,$.L(b,$.tf)?(b=b.eb(),cK(this,b),d.clip(null)):$.L(b,$.X)&&(b.ka(this.W),b.ba(!1),b.X(),d.oc(1,0,0,1,0,0),d.clip($.Si(this.zc,this.pc,this.G+2))),this.ta&&this.G&&this.ta.Dp(this.zc).Ep(this.pc))};
$.g.Ed=function(a,b){if(NJ(this)){var c=a,d=this.aa();c=$.Hk(c);var e=1==c,f=2==c,h=this.labels(),k=f?this.Ga.labels():e?this.Ca.labels():null,l=d.get("normal");l=$.n(l)?l.label:void 0;var m=f?d.get("selected"):e?d.get("hovered"):void 0;m=$.n(m)?m.label:void 0;l=$.zn(l,d.get("label"));m=f?$.zn(m,d.get("selectLabel")):e?$.zn(m,d.get("hoverLabel")):null;var p=d.ja();c=h.Qd(p);var q=l&&$.n(l.enabled)?l.enabled:null,r=m&&$.n(m.enabled)?m.enabled:null;e=e||f?null===r?null===k.enabled()?null===q?c&&$.n(c.enabled())?
c.enabled():h.enabled():q:k.enabled():r:null===q?c&&$.n(c.enabled())?c.enabled():h.enabled():q;q=this.Fc(!0);r=this.Oi();if(e){if(f=!c)c=h.add(q,r,p);h=c.enabled();c.Xh();$.Ss(c,k);c.Zc(l,m);c.enabled(h);d=d.j("anchor");$.n(d)&&c.anchor(d);f||c.X()}else c?(h=c.enabled(),c.clear(),c.enabled(h)):(c=h.add(q,r,p),d=d.j("anchor"),$.n(d)&&c.anchor(d),c.enabled(!1));if(b&&(d=c)&&this.D){k=d.ja();var t;(t=this.D[k])?d&&0!=d.enabled()&&e?$J(this,d,t):t.clear():e?$J(this,d,this.Uc):this.Uc.clear()}return c}a=
$.Hk(a);t=1==a;r=2==a;var u=this.aa();c=this.labels();d=r?this.Ga.labels():t?this.Ca.labels():null;k=u.get("normal");k=$.n(k)?k.label:void 0;l=r?u.get("selected"):t?u.get("hovered"):void 0;l=$.n(l)?l.label:void 0;k=$.zn(k,u.get("label"));l=r?$.zn(l,u.get("selectLabel")):t?$.zn(l,u.get("hoverLabel")):null;m=u.ja();h=c.Qd(m);p=k&&$.n(k.enabled)?k.enabled:null;e=l&&$.n(l.enabled)?l.enabled:null;f=this.Oi();q=this.Fc(!0);var v=this.i("mode3d");r=t||r;var w=!0;if((!r||r&&!this.i("forceHoverLabels"))&&
"allow-overlap"!=this.i("overlapMode")){var x=u.j("start"),y=u.j("sweep");w=this.zc;var A=this.pc,E=ZJ(this,a);if(E){var C=(x+y/2)*Math.PI/180;var N=(v?.45*E:E)*Math.sin(C);w+=E*Math.cos(C);A+=N}C=x*Math.PI/180;E=w+this.b*Math.cos(C);N=A+(v?.45*this.b:this.b)*Math.sin(C);C=(x+y)*Math.PI/180;x=w+this.b*Math.cos(C);C=A+(v?.45*this.b:this.b)*Math.sin(C);this.Za?this.Za.clear():this.Za=new $.yv;this.Za.vf(q);this.Za.rc(f);this.Za.Xh();$.Rs(this.Za,this.labels());$.Ss(this.Za,c);this.Za.Zc(k,l);v=this.labels().vk(this.Za,
null,null,m);y=(u=(1==u.Ob()||360==y)&&!this.G)||!IJ(w,A,x,C,v);C=!JJ(w,A,this.b,v);x=u||JJ(w,A,this.G,v);w=(u||!IJ(E,N,w,A,v))&&y&&C&&x}(r?null===e?null===d.enabled()?null===p?c.enabled():p:d.enabled():e:null===p?c.enabled():p)&&w?(h?(h.vf(q),h.rc(f)):h=c.add(q,f,m),h.Xh(),$.Ss(h,d),h.Zc(k,l),t&&!h.O()&&c.Le()&&(h.O(c.Le()),h.O().parent()||h.O().parent(c.O()))):h&&c.clear(h.ja());return h};
$.g.oI=function(){if(!this.i("mode3d")&&this.dA().i("enabled")&&0<this.dA().i("duration"))if(this.hg&&1==this.hg.ec)this.hg.update();else if(this.J(2048)){$.Zc(this.hg);this.hg=new $.nz;var a=this.dA().i("duration"),b=a*(1-.85);a=new KJ(this,.85*a);b=new OJ(this,b);this.hg.add(a);this.hg.add(b);this.hg.qa("begin",function(){this.Vh=this.i("connectorStroke");this.ca.connectorStroke="none";$.iv(this,!0);$.Rp(this,{type:"animationstart",chart:this})},!1,this);this.hg.qa("end",function(){this.ca.connectorStroke=
this.Vh;$.iv(this,!1);$.Rp(this,{type:"animationend",chart:this})},!1,this);this.hg.play(!1)}};$.g.Yx=function(a,b){var c=this.aa(),d="hatch"+String(a.charAt(0)).toUpperCase()+a.substr(1);if(b){var e=c.j(a);var f=c.j(d);e&&e.clear();f&&f.clear()}else e=$.qz(this.Ze),c.j(a,e),f=$.qz(this.Ze),c.j(d,f);return e};$.g.o$=function(){$.Rj(405,null,["getCenterPoint()","center().getPoint()"],!0);return this.Dx().vd()};$.g.BP=function(){return[this.zc,this.pc]};$.g.nX=function(){return this.W};$.g.Y5=function(){return this.b};
$.g.JX=function(){return this.G};$.g.x$=function(a){return ZJ(this,a)};$.g.wi=function(){return this.i("startAngle")+-90};$.g.vd=function(a){var b=new PJ(this,a),c;this.aa().select(a)&&b.kw()&&!WJ(c=b.get("value"))&&(a=c/this.Tf("sum")*100,b.ya("percentValue",a),b.ya("yPercentOfTotal",a));return b};
$.g.Il=function(a,b){var c=[],d=this.aa().reset(),e="aquastyle"==this.ia.i("fill");if(e){var f=this.nb;this.nb={}}for(;d.advance();){var h=d.ja();var k=d.get("legendItem")||{},l=null;$.G(b)&&(l=this.Fc(),l=b.call(l,l),$.B(l)&&(l=String(l)));$.z(l)||(l=d.j("groupedPoint")?d.j("name"):String($.n(d.get("name"))?d.get("name"):d.get("x")));var m=this.i("mode3d"),p=TJ("fill",1,!1),q=TJ("stroke",2,!1),r=TJ("hatchFill",3,!1);l={enabled:!0,meta:{pointIndex:h,pointValue:d.get("value")},iconType:"square",text:l,
iconStroke:m?$.sk(rK(this,$.Jk),.2):q(this,$.Jk,!1,null),iconFill:m?rK(this,$.Jk):p(this,$.Jk,!1,null),iconHatchFill:r(this,$.Jk,!1,null)};$.Ec(l,k);l.sourceUid=$.na(this);l.sourceKey=h;c.push(l)}e&&(this.nb=f);return c};$.g.qr=function(){return!0};$.g.gq=function(a){a=a.Gh();this.data().aa().select(a)&&this.select(a)};$.g.Yo=function(a,b){var c=a.Gh();if(!a||null!=c||(0,window.isNaN)(c))if(c=$.Ym(b.domTarget))c.U=this};
$.g.Xo=function(a,b){var c=a.Gh();if(!a||null!=c||(0,window.isNaN)(c))if(c=$.Ym(b.domTarget))c.U=this};$.g.V9=function(a,b){$.Rj(405,null,["explodeSlice()","select()"],!0);var c=$.av(this.state,a);b||!$.n(b)?c&2||this.select(a):this.Dd(a);return this};$.g.W9=function(a){$.Rj(405,null,["explodeSlices()","select()"],!0);$.da(a)?a?this.select():this.Dd():this.select(a);return this};$.g.cr=function(){return[]};
$.g.Cf=function(a){a=$.X.prototype.Cf.call(this,a);var b=$.Ym(a.domTarget).index;if(!$.n(b)&&$.$u(this.state,1)){var c=$.fv(this.state,1);c.length&&(b=c[0])}b=$.R(b);(0,window.isNaN)(b)||(a.pointIndex=a.sliceIndex=b);return a};$.g.Zg=function(a){(a=this.Wf(a))&&this.dispatchEvent(a)};
$.g.Wf=function(a){var b;"pointIndex"in a?b=a.pointIndex:"labelIndex"in a?b=a.labelIndex:"markerIndex"in a&&(b=a.markerIndex);b=$.R(b);if((0,window.isNaN)(b))return null;a.pointIndex=b;var c=a.type;switch(c){case "mouseout":c="pointmouseout";break;case "mouseover":c="pointmouseover";break;case "mousemove":c="pointmousemove";break;case "mousedown":c="pointmousedown";break;case "mouseup":c="pointmouseup";break;case "click":c="pointclick";break;case "dblclick":c="pointdblclick";break;default:return null}var d=
this.data().aa();d.select(b)||d.reset();return{type:c,actualTarget:a.target,pie:this,iterator:d,sliceIndex:b,pointIndex:b,target:this,originalEvent:a,point:this.vd(b)}};$.g.Ma=function(a){return $.n(a)?(this.ia.N(a),this):this.ia};$.g.gb=function(a){return $.n(a)?(this.Ca.N(a),this):this.Ca};$.g.Xk=function(a){return $.n(a)?(a=$.dj(a),a!=this.Th&&(this.Th=a),this):this.Th};$.g.Wi=function(a){$.n(a)?this.Uh(a):this.Qj();return this};
$.g.sd=function(a){var b;(b=$.$u(this.state,1))||(b=!!(this.state.Ti()&1));b&&this.enabled()&&($.n(a)?this.state.bh(1,a):this.state.bh(1,!0),sK(this))};$.g.Uh=function(a,b){if(!this.enabled())return this;if($.D(a))for(var c=$.fv(this.state,1),d=0;d<c.length;d++)$.ya(a,c[d])||this.state.bh(1,c[d]);$.dv(this.state,a);$.n(b)&&this.uN(b);return this};$.g.Qj=function(){this.enabled()&&this.state.Kg(1,!0)};$.g.selected=function(a){return $.n(a)?(this.Ga.N(a),this):this.Ga};
$.g.Ci=function(a){return $.n(a)?(a=$.ej(a),a!=this.mg&&(this.mg=a),this):this.mg};$.g.select=function(a){if(!this.enabled())return this;$.n(a)?this.Yh(a):this.ot();return this};$.g.ot=function(){sK(this);this.state.Kg(2,!0)};$.g.Yh=function(a,b){var c=b&&b.shiftKey?void 0:b?1:$.Jk;$.D(a)?(b||this.Dd(),this.state.Kg(2,a,c)):$.B(a)&&this.state.Kg(2,a,c);return this};$.g.Dd=function(a){$.n(a)?this.state.bh(2,a):this.state.bh(2,!0)};
$.g.Fj=function(a,b){var c=this.aa(),d=c.j("explode");this.i("mode3d")?(mK(this),pK(this,c.ja(),!0)):eK(this,a,!0);this.Ed(a);return b||d!=ZJ(this,a)};$.g.rl=function(a){var b=this.aa(),c=b.j("sweep"),d=b.get("value"),e=b.ja();1==b.Ob()||360==c||WJ(d)&&e!=b.Ob()||(a?NJ(this)?(this.ng=!1,$.V(this.labels()),this.labels().clear(),aK(this),this.labels().X(),this.labels().ba(!1)):(this.labels().clear(),b.select(e)):this.labels().X())};$.g.ek=$.ha;$.g.Ro=$.ha;
$.g.TH=function(){var a=new $.ku(0);$.M(this,a);a.va(this);$.ou(a,this);$.U(a,this.ip,this);$.Qp(this,"tooltip",a);return a};$.g.ip=function(){this.Ya().X()};$.g.uN=function(a){var b=$.Pp(this,"legend");if(!a||!b||a.target!=b){b=this.Ya();var c=this.Fc();a&&($.V(b),$.Cu(b,a.clientX,a.clientY,c),b.ba(!1),this.qa($.bj()||$.aj()?"touchstart":"mousemove",this.uN))}};$.g.Jj=function(){return this.Fc()};
$.g.F=function(){var a=RJ.B.F.call(this);a.data=this.data().F();a.palette=this.Yb().F();a.hatchFillPalette=this.Sd().F();$.Pp(this,"tooltip")&&(a.tooltip=this.Ya().F());this.Dx()&&(a.center=this.Dx().F());$.mp(this,AK,a,"Pie");a.normal=this.ia.F();a.hovered=this.Ca.F();a.selected=this.Ga.F();return{chart:a}};
$.g.$=function(a,b){RJ.B.$.call(this,a,b);$.ep(this,AK,a,b);this.group(a.group);this.data(a.data);"center"in a&&this.Dx().fa(!!b,a.center);"tooltip"in a&&this.Ya().fa(!!b,a.tooltip);"normal"in a&&this.Ma().fa(!!b,a.normal);"hovered"in a&&this.gb().fa(!!b,a.hovered);"selected"in a&&this.selected().fa(!!b,a.selected);"hatchFillPalette"in a&&this.Sd().fa(!!b,a.hatchFillPalette);"palette"in a&&this.Yb(a.palette)};
$.g.sf=function(){this.ia.ib(this.pa);$.Qp(this,"normal",this.ia);this.ia.fa(!0,{});$.Qp(this,"hovered",this.Ca);this.Ca.fa(!0,{});$.Qp(this,"selected",this.Ga);this.Ga.fa(!0,{})};$.g.R=function(){$.$c(this.hg,this.ia,this.Ca,this.Ga,this.f);RJ.B.R.call(this)};$.g=tK.prototype;$.g.$z=function(a){a&&(this.labels.push(a),this.kb())};$.g.eb=function(){if(!this.gk){var a=this.labels[0]?this.xf.Tn(this.labels[0]).height:0;this.gk=new $.K(this.x,this.y+a/2,this.width,this.height)}return this.gk};
$.g.Md=function(){this.gk=null};
$.g.Yv=function(){var a=this.height=0;this.Md();var b=this.G,c=this.xf.Dx(),d=c?c.vd():this.xf.BP();var e=this.xf.b+b;c=d.x;d=d.y;var f=this.xf.i("mode3d");if(f){var h=d+.45*e+this.xf.K-.1+.2*this.xf.b/2;var k=d-(.45*e+this.xf.K)+.1-.2*this.xf.b/2}else h=d+e+this.xf.K-.1,k=d-(e+this.xf.K)+.1;for(var l=0,m=this.labels.length;l<m;l++){var p=this.labels[l];e=this.xf.Tn(p);a+=e.top-this.height-e.height/2;this.height+=e.height}this.y=a/m;a=this.y+this.height;a>h&&(a=h,this.y=h-this.height);0!=this.labels.length&&
(e=this.xf.Tn(this.labels[0]).height,this.y+e<k&&(a=k-e+this.height,this.y=k-e));h=this.xf.i("outsideLabelsCriticalAngle");this.b.length=0;k=this.xf.data().aa();this.width=this.x=window.NaN;this.K=null;this.o=this.D=window.NaN;this.gF=!1;l=0;for(m=this.labels.length;l<m;l++){p=this.labels[l];e=this.xf.Tn(p);var q=l==m-1?0:this.xf.Tn(this.labels[l+1]).height;var r=p.ja();k.select(r);var t=k.j("start");var u=k.j("sweep");(r=$.n(p.i("offsetX"))?p.i("offsetX"):this.xf.labels().i("offsetX"))||(r=0);r=
$.O(r,360);var v=$.n(p.i("offsetY"))?p.i("offsetY"):this.xf.labels().i("offsetY");v||(v=0);p=$.O(v,this.xf.b);var w=$.J(t+u/2+r);u=this.f?5:-5;var x=this.xf.b+b;var y=this.xf.b+this.xf.K+b+p;if(f){var A=.45*(this.xf.b+b);var E=.45*(this.xf.b+b+p)+this.xf.K}else A=x,E=y;t=a;var C=x+this.xf.K;var N=A+this.xf.K;Math.abs(t-d)>N&&(N=Math.abs(t-d));N=C*Math.sqrt(Math.pow(N,2)-Math.pow(t-d,2))/N;C=c+(this.f?1:-1)*Math.abs(N);x=c+x*Math.cos(w);A=d+A*Math.sin(w);var P=c+y*Math.cos(w);w=d+E*Math.sin(w);E=Math.floor($.Nl(C,
t,c,d))+v;v=Math.abs($.ub(C-x,t-A,P-x,w-A));y=0>N||E>y;if(v>this.o||(0,window.isNaN)(this.o)||y){this.o=0>N?Number.POSITIVE_INFINITY:v;N=window.Infinity;for(E=w=0;E<this.labels.length;E++)k.select(this.labels[E].ja()),x=k.get("value"),(0,window.isNaN)(+x)||(x=+x),x<N&&(N=x,w=E);this.K=this.labels[w];this.D=w}if(v>h||y)this.gF=!0;u=C+u;C=this.f?u:u-e.width;this.x=(0,window.isNaN)(this.x)?C:this.x>C?C:this.x;C=this.f?u+e.width:u;this.width=(0,window.isNaN)(this.width)?C:this.width<C?C:this.width;u-=
c;t-=d;f&&(t+=.2*this.xf.b/2);C=Math.sqrt(Math.pow(u,2)+Math.pow(t,2))-p;p=Math.sqrt(Math.pow(u,2)+Math.pow(t,2))-p;y=window.NaN;0<u&&0<=t?y=$.$a(Math.atan(t/u)):0<u&&0>t?y=$.$a(Math.atan(t/u))+360:0>u?y=$.$a(Math.atan(t/u))+180:!u&&0<t?y=90:!u&&0>t&&(y=270);y-=r;this.b.push(y,C,p);a-=e.height/2+q/2}this.width-=this.x};
$.g.kb=function(){this.Yv();if(this.gF){var a=this.K,b=this.D;(0,window.isNaN)(b)||(a.enabled(!1),this.Qn||(this.Qn=[]),this.Qn.push(a),$.Aa(this.labels,b,1));var c=this.xf;a=this.labels;var d=this.g,e,f,h=d[d.length-1];if(h!=this){var k=null;b=a.slice();var l=d.length,m=!1;var p=0;for(e=a.length;p<e;p++)if(f=a[p]){var q=c.Tn(f);!h||vK(h,q)?!k||vK(k,q)?(k&&(d.push(k),h=k),q="left-center"==f.anchor(),k=new tK(q,c,d,this.G),uK(k,f)):(uK(k,f),c.gF?(f.enabled(!1),k.Qn||(k.Qn=[]),k.Qn.push(f),k.labels.pop(),
k.Yv()):h&&k&&!vK(h,k.eb())&&(d.pop(),k.labels=$.Ea(h.labels,k.labels),h=null,k.Yv(),m=!0)):(f.enabled(!1),k&&(k.Qn||(k.Qn=[]),k.Qn.push(f)))}if(k)if(0<d.length-l||m)this.labels=k.labels;else{c=k;if(c.Qn){d=0;for(p=c.Qn.length;d<p;d++)c.Qn[d].enabled(!0);c.Qn.length=0}b.length!=a.length&&(this.labels=b)}}this.kb()}else if((a=this.g[this.g.length-1])&&(b=a.eb()),b&&!vK(this,b)){this.g.pop();this.labels=$.Ea(a.labels,this.labels);a=0;for(b=this.labels.length;a<b;a++)this.labels[a].enabled(!0);this.kb()}};
var BK=RJ.prototype;BK.explodeSlice=BK.V9;BK.explodeSlices=BK.W9;BK.center=BK.Dx;BK.group=BK.group;BK.data=BK.data;BK.labels=BK.labels;BK.getCenterPoint=BK.o$;BK.getPixelRadius=BK.Y5;BK.getPixelInnerRadius=BK.JX;BK.getPixelExplode=BK.x$;BK.palette=BK.Yb;BK.tooltip=BK.Ya;BK.hatchFillPalette=BK.Sd;BK.getType=BK.Qa;BK.getPoint=BK.vd;BK.toCsv=BK.il;BK.hover=BK.Wi;BK.unhover=BK.sd;BK.select=BK.select;BK.unselect=BK.Dd;BK.normal=BK.Ma;BK.hovered=BK.gb;BK.selected=BK.selected;$.no.pie=wK;$.no["pie-3d"]=xK;$.H("anychart.pie",wK);$.H("anychart.pie3d",xK);}).call(this,$)}
